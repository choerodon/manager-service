...
var Route = (_dec = _form2['default'].create({}), _dec2 = (0, _mobxReact.inject)('AppState'), _dec(_class = (0, _reactRouterDom.withRouter)(_class = (0, _reactIntl.injectIntl)(_class = _dec2(_class = (0, _mobxReact.observer)(_class = function (_Component) {
  ...
  function Route(props) {
    ...
    _this.handleDelete = function (record) {
      ...
      _modal2['default'].confirm({
        ...
        onOk: function onOk() {
          return _boot.axios['delete']('/manager/v1/routes/' + record.id).then(function (_ref) {
      ...
      _this.props.form.validateFields(function (err, _ref2, modify) {
        ...
        if (!err) {
          ...
          if (show === 'create') {
            ...
            _boot.axios.post('/manager/v1/routes', JSON.stringify(body)).then(function (_ref3) {
            ...
            _boot.axios.post('/manager/v1/routes/' + id, JSON.stringify(_body)).then(function (_ref4) {
    ...
    _this.checkName = function (rule, value, callback) {
      ...
      _boot.axios.post('/manager/v1/routes/check', JSON.stringify({ name: value })).then(function (_ref5) {
    ...
    _this.checkPath = function (rule, value, callback) {
      ...
      _boot.axios.post('/manager/v1/routes/check', JSON.stringify({ path: value })).then(function (_ref6) {
  ...
  (0, _createClass3['default'])(Route, [{
    ...
    value: function getService() {
      ...
      _boot.axios.get('manager/v1/services').then(function (res) {
        _this2.setState({
          serviceArr: res
        });
      });
    ...
    value: function fetch(_ref8, _ref9, _ref10, params) {
      ...
      return _boot.axios.get('/manager/v1/routes?' + _queryString2['default'].stringify(queryObj));
    }
