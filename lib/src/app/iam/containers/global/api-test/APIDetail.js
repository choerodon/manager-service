...
var instance = _boot.axios.create();
  ...
  (0, _createClass3['default'])(APIDetail, [{
    ...
    value: function componentWillMount() {
      ...
      if (_apiTest2['default'].getApiDetail.description === '[]') {
        ...
        _boot.axios.get(urlPrefix + '/manager/v1/swaggers/' + service + '/controllers/' + controller + '/paths?' + _queryString2['default'].stringify(queryObj)).then(function (data) {
