...
var CreateConfig = (_dec = (0, _mobxReact.inject)('AppState'), _dec(_class = (0, _mobxReact.observer)(_class = function (_Component) {
  ...
  (0, _createClass3['default'])(CreateConfig, [{
    ...
    value: function loadCurrentServiceConfig(serviceName) {
      ...
      _boot.axios.get('/manager/v1/services/' + serviceName + '/configs?' + _queryString2['default'].stringify(queryObj)).then(function (data) {
        if (data.failed) {
          Choerodon.prompt(data.message);
        } else {
          _this3.setState({
    ...
    value: function getConfigYaml() {
      ...
      _boot.axios.get('manager/v1/configs/' + configId + '/yaml').then(function (data) {
        if (data.failed) {
          Choerodon.prompt(data.message);
        } else {
          _this4.setState({
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_boot.Header, {
