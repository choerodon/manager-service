...
var MenuStore = _boot.stores.MenuStore;
...
var SiteStatisticsStore = (_dec = (0, _boot.store)('SiteStatisticsStore'), _dec(_class2 = (_class3 = function () {
  function SiteStatisticsStore() {
    ...
    this.loadChart = function (beginDate, endDate, level) {
      ...
      return _boot.axios.get('/manager/v1/statistic/menu_click?' + _queryString2['default'].stringify(queryObj)).then(function (data) {
        if (data.failed) {
    ...
    this.getMenuData = function (level) {
      return _boot.axios.get('/iam/v1/menus/menu_config?level=' + level).then(function (data) {
